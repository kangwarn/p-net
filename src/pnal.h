...
#define PNAL_ETH_AUTONEG_CAP_10000BaseT_FULL_DUPLEX BIT (4)
#define PNAL_ETH_AUTONEG_CAP_10000BaseT_HALF_DUPLEX BIT (5)
...
typedef enum pnal_eth_mau
{
   ...
   PNAL_ETH_MAU_COPPER_10000BaseT_HALF_DUPLEX = 0x2D,
   PNAL_ETH_MAU_COPPER_10000BaseT_FULL_DUPLEX = 0x2E,
